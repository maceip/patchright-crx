    ...
    const oldUtilityScriptSerializerSourceContent = `
      ...
      export function source() {
        ...
        const typedArrayConstructors: Record<TypedArrayKind, Function> = {
          ...
          i32: Int32Array,
          ui32: Uint32Array,
          f16: typeof Float16Array !== 'undefined' ? Float16Array : undefined,
          f32: Float32Array,
          f64: Float64Array,
          bi64: BigInt64Array,
        ...
        function parseEvaluationResultValue(value: SerializedValue, handles: any[] = [], refs: Map<number, object> = new Map()): any {
          ...
          if (typeof value === 'object' && value) {
            ...
            if ('ta' in value) {
              const TypedArrayConstructor = typedArrayConstructors[value.ta.k];
              if (!TypedArrayConstructor) {
                // Handle unsupported typed arrays (e.g., Float16Array in older browsers)
                throw new Error(`Unsupported typed array kind: ${value.ta.k}`);
              }
              return base64ToTypedArray(value.ta.b, TypedArrayConstructor);
            }
          }
          return value;
        }
